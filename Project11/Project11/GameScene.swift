...
//  Project11
//
//  Created by MadiApps on 28/10/2021.
//
...
class GameScene: SKScene, SKPhysicsContactDelegate {
    ...
    var ballsLeft = 5 {
        didSet {
            if ballsLeft >= 0 {
                ...
                ballsLeftLabel.text = "No Balls left :("
            }
        }
    }
    ...
    override func touchesBegan(_ touches: Set<UITouch>, with event: UIEvent?) {
        ...
        if objects.contains(editLabel) {
            ...
            if editingMode {
                ...
                ballsLeft -= 1
                if ballsLeft >= 0 {
                    let ballColors = [0: "ballRed", 1: "ballBlue", 2: "ballCyan", 3: "ballGreen", 4: "ballGrey", 5: "ballPurple", 6: "ballYellow"]
    ...
    func collision(between ball: SKNode, and object: SKNode) {
        ...
        if ballsLeft == 0 {
            // show alert game over / play again / quit
        }
    }
    
    func destroy(ball: SKNode) {
        if let fire = SKEmitterNode(fileNamed: "MagicParticle") {
